...
struct PuzzleSymbols {
	...
	PuzzleSymbols(std::vector<std::pair<int, int>> symbolVec) {
		for (std::pair<int, int> s : symbolVec) {
			...
			else if (s.first == Decoration::Pipe_B) symbols[Decoration::Pipe_B].push_back(s);
			else if (s.first == Decoration::Pipe_A) symbols[Decoration::Pipe_A].push_back(s);
			else if (s.first == Decoration::Pipe_9) symbols[Decoration::Pipe_9].push_back(s);
			else if (s.first == Decoration::Pipe_8) symbols[Decoration::Pipe_8].push_back(s);
			else if (s.first == Decoration::Pipe_7) symbols[Decoration::Pipe_7].push_back(s);
			else if (s.first == Decoration::Pipe_6) symbols[Decoration::Pipe_6].push_back(s);
			else if (s.first == Decoration::Pipe_5) symbols[Decoration::Pipe_5].push_back(s);
			else if (s.first == Decoration::Pipe_4) symbols[Decoration::Pipe_4].push_back(s);
			else if (s.first == Decoration::Pipe_3) symbols[Decoration::Pipe_3].push_back(s);
			else if (s.first == Decoration::Pipe_2) symbols[Decoration::Pipe_2].push_back(s);
			else if (s.first == Decoration::Pipe_1) symbols[Decoration::Pipe_1].push_back(s);
